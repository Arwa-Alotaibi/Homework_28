...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .requestMatchers( "/api/v1/users/register","/api/v1/product/update/**","/api/v1/product","/api/v1/product/add","/api/v1/product/delete/**","/api/v1/product/getproduct","/api/v1/orders/delete/**","/api/v1/orders/Status/**","/api/v1/product/get/product/**").permitAll()
                .requestMatchers("/api/v1/user/all-users","/api/v1/product/add" ,"/api/v1/user/user/**", "/api/v1/users/delete/**",
